...
class Profile extends MY_Controller {
    ...
    public function getUserSalaryMonth_get()
    {
       
        $emp_id =  $this->user->id;
        $salaryMonth = $this->profile->getUserSalaryMonth($emp_id);
        $this->set_response($salaryMonth, REST_Controller::HTTP_OK);
    }
	...
	public function profile_post() {
    	...
    	$this->set_response($profileDetails, REST_Controller::HTTP_OK);
    }
    ...
    public function generatepayslip_post(){
        ...
        $PayslipDetail = $this->profile->generatepayslip($postData);  
