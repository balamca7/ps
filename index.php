      ...
      <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
        <meta name="viewport" content="width=device-width,initial-scale=1">
          <title>BM Associates</title>
             ...
             <link rel="shortcut icon" href="dist/img/logo_bma.png" type="image/x-icon">
<link rel="icon" href="dist/img/logo_bma.png" type="image/x-icon">

  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>BMAssociates</title>
...
<script src="app/Controller/scheduleCtrl.js"></script>	
  ...
  <script src="app/Controller/paysilpCtrl.js"></script>
